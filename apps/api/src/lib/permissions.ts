...
export const PERMISSION_DEFINITIONS = [
  ...
  { key: "RIDERS", label: "Riders", routePrefix: "/admin/riders", permissionGroup: "Operations", sortOrder: 102 },
  { key: "DELIVERIES", label: "Dispatch", routePrefix: "/admin/dispatch", permissionGroup: "Operations", sortOrder: 104 },
