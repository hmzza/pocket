...
export default function BusinessHealthPage() {
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-4 py-10 md:px-6"><AdminShell title="Business Health" description="A compact operating scorecard that turns the most important signals into next actions.">
